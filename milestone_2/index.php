...
<div id="app">
    ...
    <main id="site_main">
        <div class="filter d-flex justify-content-center my-4">
            ...
            <div class="select">
                <p>Filter by genre:</p>
                <select class="form-select m-auto" v-model="selectedGenre" @change="filterGenre(selectedGenre)">
            ...
            <div class="select">
                ...
                <select class="form-select m-auto" v-model="selectedArtist" @change="filterArtist(selectedArtist)">
                    <option selected value="">All</option>
